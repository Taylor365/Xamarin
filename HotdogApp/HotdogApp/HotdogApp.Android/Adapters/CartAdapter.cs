...
namespace RaysHotDogs.Adapters
{
    public class CartAdapter: BaseAdapter<CartItem>
    {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            var imageBitmap = ImgHelper.GetImageBitmapFromUrl("http://gillcleerenpluralsight.blob.core.windows.net/files/" + item.HotDog.ImagePath + ".jpg");
