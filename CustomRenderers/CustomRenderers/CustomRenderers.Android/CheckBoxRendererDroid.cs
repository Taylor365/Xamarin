...
[assembly: ExportRenderer(typeof(Checkbox), typeof(CheckboxRendererDroid))]
namespace CustomRenderers.Droid
{
  public class CheckboxRendererDroid : ViewRenderer<Checkbox, AppCompatCheckBox>, CompoundButton.IOnCheckedChangeListener
  {
    private const int DEFAULT_SIZE = 28;

    public CheckboxRendererDroid(Context context) : base(context)
    {
    }
